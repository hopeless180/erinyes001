...
<html>
  ...
  <ul>
  	...
  	<li><a href = "" target = "main_right">派工单</a></li>
  	<li><a href = "" target = "main_right">领料单</a></li>
  	<li><a href = "" target = "main_right">质检单</a></li>
  	<li><a href = "" target = "main_right">入库单</a></li>
  	<li><a href = "" target = "main_right">出库单</a></li>
  </ul>
  <ul>
  	调度模块
  	<li><a href = "" target = "main_right">员工信息表</a></li>
  	<li><a href = "" target = "main_right">生产工序</a></li>
  	<li><a href = "" target = "main_right">人员调度表</a></li>
  </ul>
  <ul>
  	防错模块
  	<li><a href = "" target = "main_right">出错申报表</a></li>
  	<li><a href = "" target = "main_right">错误处理单</a></li>
  </ul>
